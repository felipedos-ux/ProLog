...
# BGL Production Optimization and Recall Enhancement Plan

> Implement production-ready inference (K=5), code refactoring to OpenStack standards, and explore hybrid methods for remaining recall gap.
...
- **Total symbols discovered:** 235
- **Architecture layers:** Models, Repositories, Config, Utils
- **Detected patterns:** Builder

### Key Components
**Core Classes:**
- `TopKAnomalyDetector` — D:\ProLog\topk_detector.py:17
- `BGLTemplateDataset` — D:\ProLog\topk_dataset.py:15
- `BGLSlidingDataset` — D:\ProLog\finetune_bgl_sliding.py:49
- `CausalSelfAttention` — D:\ProLog\universal_detector\model.py:7
- `MLP` — D:\ProLog\universal_detector\model.py:44
## Agent Lineup
