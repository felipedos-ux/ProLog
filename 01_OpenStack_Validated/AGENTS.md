...
## Repository map
- `calibrate_adaptive.py/` — explain what lives here and when agents should edit it.
- `config.py/` — explain what lives here and when agents should edit it.
- `dataset.py/` — explain what lives here and when agents should edit it.
- `detect_custom.py/` — explain what lives here and when agents should edit it.
- `docs/` — explain what lives here and when agents should edit it.
- `model_weights/` — explain what lives here and when agents should edit it.
- `model.py/` — explain what lives here and when agents should edit it.
- `models/` — explain what lives here and when agents should edit it.
